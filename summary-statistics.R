...
write.csv(weekly.admissions, file=paste0(output.directory, '/', Sys.Date(), ' NeoTree Weekly Admissions.csv'),
          row.names = T)
...
write.csv(weekly.discharges, file=paste0(output.directory, '/', Sys.Date(), ' NeoTree Weekly Discharges.csv'),
          row.names = T)
...
write.csv(Tab, file=paste0(output.directory, '/', 'DischargeMatchedByHCWID.csv'), row.names = T)
...
write.csv(tabU, file=paste0(output.directory, '/', 'DischargeUnmatchedByHCWID.csv'), row.names = T)
...
write.csv(final.database.df, file=paste0(output.directory, '/', Sys.Date(), ' Final.csv'),
          row.names = T)
